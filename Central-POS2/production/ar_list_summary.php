              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <form class="form-horizontal" action="controller/functions.php?p_start_date=<?=$p_start_date?>&p_end_date=<?=$p_end_date?>" method="post" name="upload_excel" enctype="multipart/form-data">
